...
Given start (A) and end (B) coordinates, you will write a function that outputs the shortest path for a Knight on a chess board to travel from A to B as an array of coordinates. Details are given in the assignment below, but first some pointers.
